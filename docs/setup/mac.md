...
- Launch VS Code.
- Open the **Command Palette** (`kbstyle(F1)`) by holding down {Command+Shift+P} and type 'shell command' to find the **Shell Command: Install 'code' command in PATH** command.
